...
El proyecto se desarrollo usando [KiCAD](https://www.kicad.org/). El archivo del proyecto se encuentra en la carpeta `electronic` ([electronic.kicad_pro](electronic.kicad_pro)). Los componentes utilizados en el proyecto son:
...
* 1 Alimentación: En esta sección se encuentra el conector de la funete de alimentación para el circuito.
* 3 Motores
...
En esta sección se encuentran los modulos de controladores de motores **L298N**. 

* Las etiquetas de los pines de control de los modulos se conectan a los pines GPIO del microcontrolador.
