...
## Instalador de ROS
[install-ros.sh](installros.sh) Es un script que instala ROS2, Gazebo sim y micro-ROS. Actualmente esta diseñado para distribuciones basadas en Debian, específicamente Ubuntu.
